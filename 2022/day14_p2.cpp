...
int sandflow(std::set<Point>& points, Point start) {
  int deepest = Point::deepest_point(points) + 2;

  Point floor_start(0, deepest);
  Point floor_end(1000, deepest);
  add_points(points, floor_start, floor_end);
...
int main() {
  ...
  Point start(500, 0);
  std::cout << "Part 2: " << sandflow(points, start) << std::endl;
